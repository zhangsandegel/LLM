...
class GRPOTrainer:
    def __init__(self,model=None,reward_funcs:Union[List[str],List[Callable]]=None,args=None,train_dataset:Optional[Union[Dataset]]=None, eval_dataset :Optional[Union[Dataset]]=None,tokenizer = None,reward_tokenizers=None):
                self.args = args
        # 加载模型
...
if __name__ == "__main__":
    ...
    model = AutoModelForCausalLLM.from_pretrained('/home/user/Downloads/Qwen2.5-1.5B-Instruct')
    
    prompts_dataset = GSM8K_zh('',tokenizer)
